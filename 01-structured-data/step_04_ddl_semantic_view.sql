...
CREATE OR REPLACE VIEW AI_BI_VW_SEMANTIC_KNOWLEDGE_OPS AS
...
WITH MONTHLY_QUERY_METRICS AS (
    ...
    FROM CURATED_VW_QUERY_RESOLUTION_METRICS
    GROUP BY ALL
)
...
LEFT JOIN (
    ...
    FROM CURATED_VW_PROTOCOL_CURRENCY
...
LEFT JOIN (
    ...
    FROM CURATED_VW_COMPLIANCE_GAP_SUMMARY
...
CREATE OR REPLACE SEMANTIC VIEW SV_HEALTHCARE_KNOWLEDGE_OPS
